...
<main>
    <div class="card">
        <h2>➕ <?= isset($editar)? "Editar Catedrático" : "Agregar Catedrático" ?></h2>
        <form method="post">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="?eliminar=<?= $fila['id'] ?>" class="delete" onclick="return confirm('¿Eliminar catedrático?')">Eliminar</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </table>
